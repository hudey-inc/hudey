...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    const runAnimate = () => {
      ...
      animId.current = window.requestAnimationFrame(runAnimate);
    };
    runAnimate();
