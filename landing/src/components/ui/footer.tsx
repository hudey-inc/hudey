...
function Footer() {
  return (
    <footer className="bg-[#2F4538] px-5 sm:px-8 pt-14 sm:pt-20 pb-8 sm:pb-10">
        ...
        <div className="flex w-full flex-col justify-between gap-10 lg:flex-row lg:items-start">
          ...
          <div className="flex w-full flex-col gap-6 lg:max-w-xs">
            ...
            <p className="text-sm text-white/50 leading-relaxed">
              Influencer marketing for sustainable brands. From finding creators
              to closing deals, one platform.
            </p>
            <ul className="flex items-center gap-5">
              {/* Instagram */}
              <li>
                <a
                  href="https://instagram.com/hudeyco"
                  aria-label="Hudey on Instagram"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://x.com/hudeyco"
                  aria-label="Hudey on X (Twitter)"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white/40 hover:text-white transition-colors"
                >
