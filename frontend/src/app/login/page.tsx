        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-5 sm:p-8">
          ...
          {message !== "sent" && (
            <>
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors font-medium text-sm text-gray-700"
              >
