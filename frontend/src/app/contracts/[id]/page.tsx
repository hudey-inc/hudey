      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex items-center gap-1.5 bg-[#2F4538] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#263a2d] transition-colors disabled:opacity-50"
          >
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2F4538]/20 focus:border-[#2F4538]"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <div className="relative flex-1">
                    <select
                      ...
                      className="w-full appearance-none px-3 py-2 pr-8 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#2F4538]/20 focus:border-[#2F4538]"
                    >
                      {CLAUSE_TYPES.map((ct) => (
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#2F4538]/20 focus:border-[#2F4538]"
                />
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm resize-y focus:outline-none focus:ring-2 focus:ring-[#2F4538]/20 focus:border-[#2F4538]"
                />
              </div>
            </div>
          </div>
