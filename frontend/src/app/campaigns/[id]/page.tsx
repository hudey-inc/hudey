      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
          <div className="min-w-0">
            <h1 className="text-lg sm:text-xl font-semibold text-gray-900 truncate">{campaign.name}</h1>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            {(isDraft || isFailed) && (
              <button
                onClick={handleRun}
                disabled={starting}
                className="rounded-lg bg-indigo-600 px-4 sm:px-5 py-2 text-sm font-medium text-white hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
