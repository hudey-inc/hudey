...
function HudeyLogo({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <div className={`${className} bg-gray-900 rounded flex items-center justify-center flex-shrink-0`}>
      <svg viewBox="250 280 560 500" className="w-[70%] h-[70%]" fill="white" xmlns="http://www.w3.org/2000/svg">
